...
- **A cue for every pack item.** Each item carries `image: 'cue:<slug>'`, and
  ...
  sixteen phrases that are about agreeing, so 4,894 cards resolve to 371
  pictures.
