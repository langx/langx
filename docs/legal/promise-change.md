...
| Suspension       | A reported account may be suspended after a person reviews the report — for a stated period, shown in the app with its end date, or permanently. While suspended you cannot use the app and your profile is out of discovery and search, though somebody who already has a conversation with you can still open it, marked as suspended. Subscriptions are not cancelled by a suspension and must be cancelled with the store; tokens and streak are kept but nothing is earned. One appeal per suspension, from the app or hi@langx.io |
