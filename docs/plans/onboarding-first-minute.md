...
## Status on 10 September 2026

**Not started.** Saved as a plan on the day it was written; nothing below is
built yet, and the work waits for Behic's go-ahead.
...
**Working agreement.** Do not open a pull request, and do not push a branch,
unless you are asked to. Commit on the branch you are told to use and stop
there; opening a PR is Behic's call, not yours. The same goes for anything
else outward-facing.
