...
export const DRAWINGS = {
  ...
  lemon: {
    label: 'A lemon',
    body: `
      <path d="M96 172 C104 158 116 150 128 146 C138 116 166 94 200 94 C234 94 262 116 272 146 C284 150 296 158 304 172 C296 186 284 194 272 198 C262 228 234 250 200 250 C166 250 138 228 128 198 C116 194 104 186 96 172 Z" fill="#ffc409"/>
      <path d="M208 98 C232 72 268 80 262 108 C246 126 218 120 208 98 Z" fill="#009f70"/>`,
  },
  'pot-of-food': {
    label: 'A pot of food',
    body: `
