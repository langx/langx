...
const ctx = await browser.newContext({ viewport: { width: 900, height: 800 }, hasTouch: false })
...
const labels = await page.evaluate(() =>
  [...document.querySelectorAll('div[dir="auto"]')].map(e => e.textContent?.trim()))
console.log('swipe layer rendered:', labels.includes('Pin'))
await browser.close()
