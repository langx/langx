...
export const ar: Localized<ServerMessages> = {
  push: {
    ...
    echoTitle: {
      zero: 'لا بطاقات الآن',
      one: 'بطاقة واحدة جاهزة',
      two: 'بطاقتان جاهزتان',
      few: '{count} بطاقات جاهزة',
      many: '{count} بطاقة جاهزة',
      other: '{count} بطاقة جاهزة',
    },
    echoBody: 'دقائق قليلة الآن، وتبقى معك.',
    ...
    reportRewardTitle: {
      zero: '{count} رمز لمساعدتك في إبقاء LangX آمنًا 🛡️',
      one: 'رمز واحد لمساعدتك في إبقاء LangX آمنًا 🛡️',
      two: 'رمزان لمساعدتك في إبقاء LangX آمنًا 🛡️',
      few: '{count} رموز لمساعدتك في إبقاء LangX آمنًا 🛡️',
      many: '{count} رمزًا لمساعدتك في إبقاء LangX آمنًا 🛡️',
      other: '{count} رمز لمساعدتك في إبقاء LangX آمنًا 🛡️',
    },
    reportRewardBody: 'راجعنا بلاغك. شكرًا لك.',
    ...
    lifetimeGiftTitle: '{plan}، مدى الحياة 🎉',
    lifetimeGiftBody: {
      zero: 'رموزك من v1 هي التي أهّلتك.',
      one: 'الرمز الذي جمعته في v1 هو الذي أهّلك.',
      two: 'الرمزان اللذان جمعتهما في v1 هما ما أهّلك.',
      few: 'رموزك الـ {total} من v1 هي التي أهّلتك.',
      many: 'رموزك الـ {total} من v1 هي التي أهّلتك.',
      other: 'رموزك الـ {total} من v1 هي التي أهّلتك.',
    },
  ...
  lifetimeGift: {
    intro: 'تهانينا — {plan} لك مدى الحياة.',
    earned: {
      zero: 'أنهيت v1 برموزك. هذا ما أهّلك: ذهبت الهدية إلى الحسابات التي بنت LangX القديم. لا تنتهي صلاحيتها أبدًا، ولا شيء عليك دفعه.',
      one: 'أنهيت v1 برمز واحد. هذا ما أهّلك: ذهبت الهدية إلى الحسابات التي بنت LangX القديم. لا تنتهي صلاحيتها أبدًا، ولا شيء عليك دفعه.',
      two: 'أنهيت v1 برمزين. هذا ما أهّلك: ذهبت الهدية إلى الحسابات التي بنت LangX القديم. لا تنتهي صلاحيتها أبدًا، ولا شيء عليك دفعه.',
      few: 'أنهيت v1 بـ {total} رموز. هذا ما أهّلك: ذهبت الهدية إلى الحسابات التي بنت LangX القديم. لا تنتهي صلاحيتها أبدًا، ولا شيء عليك دفعه.',
      many: 'أنهيت v1 بـ {total} رمزًا. هذا ما أهّلك: ذهبت الهدية إلى الحسابات التي بنت LangX القديم. لا تنتهي صلاحيتها أبدًا، ولا شيء عليك دفعه.',
      other:
        'أنهيت v1 بـ {total} رمز. هذا ما أهّلك: ذهبت الهدية إلى الحسابات التي بنت LangX القديم. لا تنتهي صلاحيتها أبدًا، ولا شيء عليك دفعه.',
    },
    wallet: {
      zero: 'انتقل رصيدك القديم بمعدل مئة رمز من v1 مقابل واحد، فصار {carried} منها في محفظتك الجديدة. لا تحتوي اليوم على شيء.',
      one: 'انتقل رصيدك القديم بمعدل مئة رمز من v1 مقابل واحد، فصار {carried} منها في محفظتك الجديدة. تحتوي اليوم على رمز واحد.',
      two: 'انتقل رصيدك القديم بمعدل مئة رمز من v1 مقابل واحد، فصار {carried} منها في محفظتك الجديدة. تحتوي اليوم على رمزين.',
      few: 'انتقل رصيدك القديم بمعدل مئة رمز من v1 مقابل واحد، فصار {carried} منها في محفظتك الجديدة. تحتوي اليوم على {balance} رموز.',
      many: 'انتقل رصيدك القديم بمعدل مئة رمز من v1 مقابل واحد، فصار {carried} منها في محفظتك الجديدة. تحتوي اليوم على {balance} رمزًا.',
      other:
  ...
  official: {
    ...
    welcomeClosing: 'نتمنى لك تدرّبًا ممتعًا — وبالتوفيق. 💛',
    welcomeBack:
      'أهلًا — سعداء بعودتك. 👋 كنت معنا في LangX الأول، وفي ملفك الآن شارة تقول ذلك. لا يملكها إلا من جاء من الإصدار الأول، ولن يحصل عليها أحد جديد أبدًا.',
    welcomeBackWhatsNew:
      'تغيّر الكثير. صارت التصحيحات بابًا قائمًا بذاته، وتكسب رموزًا حين تساعد الآخرين، و«اكتشف» يبحث عمّن يتعلّم لغتك ويتحدّث اللغة التي تريدها. الفكرة نفسها، لكن هذه المرة مع متّسع لإتقانها — تجوّل قليلًا.',
    welcomeBackClosing:
      'هنا تصلك أخبار LangX، فمن المفيد أن تتابعه. وإن نقص شيء أو تعطّل، فـ«الإعدادات ← حول ← ملاحظات» تصل إلينا مباشرة. سعداء بعودتك إلينا. 💛',
    reportReward: {
      zero: 'شكرًا على بلاغك. راجعناه وأضفنا {count} رمز إلى محفظتك لأنك تساعد في إبقاء LangX مكانًا جيدًا للتعلّم. لن يعرف الشخص الذي أبلغت عنه أبدًا من أرسل البلاغ.',
      one: 'شكرًا على بلاغك. راجعناه وأضفنا رمزًا واحدًا إلى محفظتك لأنك تساعد في إبقاء LangX مكانًا جيدًا للتعلّم. لن يعرف الشخص الذي أبلغت عنه أبدًا من أرسل البلاغ.',
      two: 'شكرًا على بلاغك. راجعناه وأضفنا رمزين إلى محفظتك لأنك تساعد في إبقاء LangX مكانًا جيدًا للتعلّم. لن يعرف الشخص الذي أبلغت عنه أبدًا من أرسل البلاغ.',
      few: 'شكرًا على بلاغك. راجعناه وأضفنا {count} رموز إلى محفظتك لأنك تساعد في إبقاء LangX مكانًا جيدًا للتعلّم. لن يعرف الشخص الذي أبلغت عنه أبدًا من أرسل البلاغ.',
      many: 'شكرًا على بلاغك. راجعناه وأضفنا {count} رمزًا إلى محفظتك لأنك تساعد في إبقاء LangX مكانًا جيدًا للتعلّم. لن يعرف الشخص الذي أبلغت عنه أبدًا من أرسل البلاغ.',
      other:
        'شكرًا على بلاغك. راجعناه وأضفنا {count} رمز إلى محفظتك لأنك تساعد في إبقاء LangX مكانًا جيدًا للتعلّم. لن يعرف الشخص الذي أبلغت عنه أبدًا من أرسل البلاغ.',
    },
    assistantOffline:
