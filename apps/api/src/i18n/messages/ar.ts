...
export const ar: Localized<ServerMessages> = {
  ...
  official: {
    welcome:
      'أهلًا بك في LangX! 👋 أنا مساعد LangX. اعثر على شريك في «اكتشف»، أرسل رسالة، واكسب الرموز وأنت تتدرّب.\n\nيمكنك مراسلتي في أي وقت: اسأل كيف يعمل شيء ما، أبلغ عن أحد، أو أخبرني عن خلل أو فكرة.',
    copilotSoon:
      'Copilot لم يصل بعد — إنه شريك التدرّب داخل المحادثة الذي نبنيه الآن. أُنشئ هذا الحساب لتجده يوم وصوله.\n\nحتى ذلك الحين، راسل ‎@langx‎ وسأساعدك.',
    assistantOffline:
      'لا أستطيع الرد على الرسائل الآن. إن كان الأمر يحتمل الانتظار فحاول لاحقًا، وإن لم يكن فراسل {email} وسيقرأها شخص.',
    assistantLimit:
      'هذا كل ما أستطيع الرد عليه اليوم. سأكون هنا غدًا، و{email} يصل إلى شخص في أي وقت.',
