...
export const ar: Localized<ServerMessages> = {
  ...
  official: {
    welcome:
      'أهلًا بك في LangX! 👋 اعثر على شريك في «اكتشف»، أرسل له رسالة، واكسب الرموز وأنت تتدرّب.\n\nمن هذا الحساب تصلك أخبار LangX، فتابعه. LangX مشروع مفتوح المصدر، وما يجعله أفضل هو ما يخبرنا به الناس: إن وجدت خللًا أو كانت لديك فكرة، فـ«الإعدادات ← حول ← ملاحظات» تصل مباشرة إلى الفريق.',
    assistantOffline:
