...
export async function updateProfile(
   ...
   * the first write they make. The first occurrence is the one kept — in the
   * learning list that is also the one with the lower priority, which is the
   * one its owner arranged.
   */
