...
export const ptBR: Localized<EnMessages> = {
  ...
  echo: {
    ...
    markLearned: 'Esta eu já sei',
    putItBack: 'Devolver',
    archived: 'Aprendidos',
    archivedEmptyTitle: 'Nada guardado ainda',
    archivedEmptyBody: 'Os cartões que você já sabe ficam aqui. Guardam tudo e param de voltar.',
    selectCards: 'Selecionar cartões',
    selectedCount: { one: '{count} selecionado', other: '{count} selecionados' },
    archivedToast: { one: '{count} cartão guardado', other: '{count} cartões guardados' },
