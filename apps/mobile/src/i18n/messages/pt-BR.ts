...
export const ptBR: Localized<EnMessages> = {
  ...
  settings: {
    ...
    voiceCreditsBody: 'As mensagens são lidas em voz alta por modelos de voz de código aberto. A maioria não nos pede nada; estas dez são licenciadas com a condição de creditarmos quem as gravou.',
