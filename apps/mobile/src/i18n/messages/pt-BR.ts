...
export const ptBR: Localized<EnMessages> = {
  ...
  tabs: { discover: 'Descobrir', chats: 'Conversas', echo: 'Echo', feed: 'Feed', me: 'Eu' },
  ...
  echo: {
    title: 'Echo',
    due: {
      one: '{count} cartão para revisar',
      other: '{count} cartões para revisar',
    },
    allCaughtUp: 'Nada para revisar agora',
    review: 'Revisar',
    allLanguages: 'Todos',
    added: 'Adicionado ao Echo',
    alreadyAdded: 'Já está no Echo',
    removed: 'Removido do Echo',
    addToEcho: 'Adicionar ao Echo',
    removeFromEcho: 'Remover do Echo',
    bubbleAdd: '+ Echo',
    bubbleAdded: 'No Echo',
    addFailedTitle: 'Não deu para adicionar este cartão',
    removeFailedTitle: 'Não deu para remover este cartão',
    limitTitle: 'Limite diário do Echo atingido',
    ...
    reviewWhich: 'Qual idioma?',
    cardPhoto: 'Imagem',
    addPhoto: 'Adicionar uma imagem',
    replacePhoto: 'Substituir a imagem',
    removePhoto: 'Remover a imagem',
    cardAudio: 'Gravação',
    recordIt: 'Fale você mesmo',
    removeAudio: 'Remover a gravação',
    ...
    voiceFemale: 'Sintetizada · feminina',
    voiceMale: 'Sintetizada · masculina',
    voiceSynthesised: 'Sintetizada',
    ...
    doneReviewed: 'Revisados',
    doneRemembered: 'Lembrados',
    doneAgain: 'De novo',
  ...
  chats: {
    ...
    unreadNew: { one: '{count} nova', other: '{count} novas' },
    tab_all: 'Todos',
  ...
  chat: {
    ...
    playbackRate: '{rate}×',
    playbackSpeed: 'Velocidade de reprodução: {rate}×',
  ...
  howItWorks: {
    title: 'Como o LangX funciona',
    featuresSection: 'Recursos de aprendizado',
    gotIt: 'Entendi',
    whatTitle: 'O que é o LangX',
    whatBody:
      'Um lugar para praticar um idioma com quem o fala. Todo mundo com quem você dá match é nativo em um idioma que você aprende e aprende um que você fala — você ensina o seu, a pessoa ensina o dela, e os dois melhoram.',
    whatBody2:
      'Aqui ninguém é professor pago. Todo mundo está aprendendo alguma coisa, e todo mundo é especialista no próprio idioma.',
    helpTitle: 'Como ajudar seu parceiro a aprender',
    helpBody: 'Um bom parceiro não é um parceiro perfeito — é alguém que facilita continuar.',
    helpTakeTurns: 'Revezem: um pouco no idioma dele, um pouco no seu.',
    helpCorrect: 'Corrija uma ou duas coisas por vez, não todos os erros de uma mensagem.',
    helpSimple: 'Escreva de forma simples e vá mais devagar quando a pessoa pedir.',
    helpQuestions:
      'Faça perguntas. Uma resposta é mais fácil de escrever do que uma primeira mensagem.',
    helpPatient: 'Tenha paciência. Você também está aprendendo.',
    rulesTitle: 'Comportamentos inaceitáveis',
    rulesLead:
      'O LangX é para praticar um idioma. Qualquer uma destas coisas pode levar à suspensão ou à remoção definitiva de uma conta.',
    rulesHarassment: 'Assédio, ou insistir depois que alguém parou de responder',
    rulesHate: 'Discurso de ódio e ofensas',
    rulesSexual: 'Conteúdo sexual e investidas indesejadas — o LangX não é um app de namoro',
    rulesMinors: 'Qualquer coisa que sexualize um menor',
    rulesImpersonation: 'Fingir ser outra pessoa ou mentir sobre a sua idade',
    rulesPrivate: 'Publicar informações privadas de outra pessoa',
    rulesSpam: 'Spam, golpes, propaganda e pedidos de dinheiro',
    rulesTopics:
      'Política e religião não são proibidas — um idioma serve de pouco se você só pode falar do tempo. Hostilidade contra uma pessoa, sim.',
    rulesBlock:
      'Bloquear funciona na hora, e a outra pessoa não fica sabendo. Denunciar envia o caso para nós.',
    rulesAccept: 'Eu entendo',
    rulesRead: 'Ler as diretrizes completas',
    holdTitle: 'Segure uma mensagem',
    holdBody:
      'Segure qualquer mensagem para ver o que dá para fazer com ela. Responder, corrigir, traduzir, copiar ou guardar no Echo — o que aparece depende da mensagem e de quem a enviou.',
    correctTitle: 'Corrija e seja corrigido',
    correctBody:
      'Segure a mensagem do seu parceiro e escolha Corrigir. Arrume o que está errado e envie: a pessoa vê exatamente o que mudou. Correções são ilimitadas em todos os planos.',
    translateTitle: 'Traduzir uma mensagem',
    translateBody:
      'Segure uma mensagem e escolha Traduzir. A tradução aparece embaixo, no seu idioma, sem sair da conversa. Se você fala mais de um, escolha qual em Configurações.',
    voiceTitle: 'Áudios',
    voiceBody:
      'Toque no microfone para gravar. Ouça antes de enviar — ouvir a palavra é metade do aprendizado.',
  ...
  editProfile: {
    ...
    usernameEvery: 'Você pode mudar isso uma vez a cada {days} dias.',
    usernameCooldown: 'Você poderá mudar de novo em {date}.',
    pronouns: 'Pronomes',
  ...
  languages: {
    title: 'Seus idiomas',
    nativeSection: 'Nativos',
    nativeBody: 'Os idiomas com que você cresceu. É assim que quem os aprende encontra você.',
    learningSection: 'Aprendendo',
    learningBody: 'O que você está aprendendo. O primeiro abre o seu perfil.',
    addNative: 'Adicionar um idioma nativo',
    addLearning: 'Adicionar um idioma que você aprende',
    pickNativeTitle: 'Idioma nativo',
    pickLearningTitle: 'Idioma que você aprende',
    replaceTitle: 'Trocar {language}',
    replaceBody: 'Escolha o idioma que entra no lugar.',
    startsAtNew: 'Começa no primeiro nível. Você muda isso depois.',
    alreadyInList: 'Você já tem {language}.',
    ...
    lastLearning:
      'Você precisa de pelo menos um idioma que aprende. Troque este em vez de removê-lo.',
    capReached: {
      one: 'Seu plano comporta {count} idioma nesta lista.',
      other: 'Seu plano comporta {count} idiomas nesta lista.',
    },
    capReachedShort: {
    ...
    saveFailed: 'Não salvou. Nada mudou.',
  },
  ...
  settings: {
    ...
    username: 'Nome de usuário',
    usernameBody: 'Mude uma vez a cada {days} dias',
    usernameTitle: 'Mudar seu nome de usuário',
    usernameIntro: 'Você é @{handle}. Escolha o nome de usuário que quer no lugar.',
    usernameIntroV1:
    ...
    usernameEvery:
      'Você pode mudar isso uma vez a cada {days} dias. Links e códigos QR com seu nome antigo continuam funcionando até você mudar de novo.',
    usernameSave: 'Mudar nome de usuário',
    ...
    usernameCooldown: 'Você é @{handle}. Você poderá mudar de novo em {date}.',
    usernameConfirmTitle: 'Mudar seu nome de usuário?',
    usernameConfirmBody: 'Você será @{handle}. Só poderá mudar de novo daqui a {days} dias.',
    password: 'Senha',
  ...
  linkDevice: {
    ...
    approve: 'Aprovar',
    deny: 'Recusar',
    approved: 'Início de sessão aprovado.',
    denied: 'Início de sessão recusado.',
  ...
  */
  ...
  widget: {
    ...
    todayName: 'Hoje',
    todayDetail: 'Sequência, não lidas e cartões do dia, lado a lado.',
