...
export const ptBR: Localized<EnMessages> = {
  ...
  filters: {
    ...
    theirMinimumLevel: 'Nível mínimo deles',
  ...
  paywall: {
    ...
    proPlusTagline: 'Tudo do Pro, mais os dois recursos que só ele tem.',
    partOf: 'faz parte do',
    ...
    restore: 'Já é assinante? Restaurar',
