...
export const tr: Localized<EnMessages> = {
  ...
  echo: {
    title: 'Echo',
    due: {
      one: '{count} kart bekliyor',
      other: '{count} kart bekliyor',
    },
    allCaughtUp: 'Şu an bekleyen kart yok',
    review: 'Tekrar et',
    allLanguages: 'Tümü',
    added: 'Echo’ya eklendi',
    alreadyAdded: 'Zaten Echo’da',
    removed: 'Echo’dan çıkarıldı',
    addToEcho: 'Echo’ya ekle',
    removeFromEcho: 'Echo’dan çıkar',
    bubbleAdd: '+ Echo',
    bubbleAdded: 'Echo’da',
    addFailedTitle: 'Bu kart eklenemedi',
    removeFailedTitle: 'Bu kart çıkarılamadı',
    limitTitle: 'Günlük Echo sınırına ulaşıldı',
    ...
    reviewWhich: 'Hangi dil?',
    cardPhoto: 'Görsel',
    addPhoto: 'Görsel ekle',
    replacePhoto: 'Görseli değiştir',
    removePhoto: 'Görseli kaldır',
    cardAudio: 'Kayıt',
    recordIt: 'Kendin söyle',
    removeAudio: 'Kaydı kaldır',
    ...
    voiceFemale: 'Sentetik · kadın',
    voiceMale: 'Sentetik · erkek',
    voiceSynthesised: 'Sentetik',
    readAloud: 'Sesli oku',
    ...
    doneReviewed: 'Tekrar edilen',
    doneRemembered: 'Hatırlanan',
    doneAgain: 'Tekrar',
  ...
  errors: {
    ...
    discordSignInFailed: 'Discord ile giriş yapılamadı',
  ...
  welcomeBack: {
    ...
    handleBodyChoose:
      'Bu adı sana eski LangX verdi. Kimse alamaz — ama istersen kendi adını seçebilirsin.',
    handleChoose: 'Kendi adımı seçeyim',
  ...
  discover: {
    ...
    searchNone: 'Bu isimde veya kullanıcı adında bir hesap yok.',
    sortLabel: 'Sıralama',
    forYou: 'Sana özel',
    title: 'Keşfet',
    active: 'Aktif',
  ...
  chat: {
    ...
    playbackRate: '{rate}×',
    playbackSpeed: 'Oynatma hızı: {rate}×',
  ...
  editProfile: {
    ...
    usernameEvery: 'Bunu her {days} günde bir değiştirebilirsin.',
    usernameCooldown: 'Yeniden değiştirebileceğin tarih: {date}.',
    pronouns: 'Zamirler',
  ...
  languages: {
    title: 'Dillerin',
    nativeSection: 'Ana dil',
    nativeBody: 'Büyürken konuştuğun diller. Bu dilleri öğrenenler seni böyle bulur.',
    learningSection: 'Öğrendiklerin',
    learningBody: 'Öğrendiğin diller. İlki profilinin başında durur.',
    addNative: 'Ana dil ekle',
    addLearning: 'Öğrendiğin bir dil ekle',
    pickNativeTitle: 'Ana dil',
    pickLearningTitle: 'Öğrendiğin dil',
    replaceTitle: '{language} dilini değiştir',
    replaceBody: 'Onun yerine geçecek dili seç.',
    startsAtNew: 'İlk seviyeden başlar. Sonrasında değiştirebilirsin.',
    alreadyInList: '{language} zaten listende.',
    ...
    lastLearning: 'En az bir öğrendiğin dil olmalı. Kaldırmak yerine bunu değiştir.',
    capReached: {
      one: 'Planın bu listede {count} dil tutuyor.',
      other: 'Planın bu listede {count} dil tutuyor.',
    },
    capReachedShort: {
    ...
    saveFailed: 'Kaydedilemedi. Hiçbir şey değişmedi.',
  },
  ...
  settings: {
    ...
    username: 'Kullanıcı adı',
    usernameBody: 'Her {days} günde bir değiştir',
    usernameTitle: 'Kullanıcı adını değiştir',
    usernameIntro: 'Şu an @{handle} sensin. Yerine istediğin kullanıcı adını seç.',
    usernameIntroV1:
      'Eski LangX’e katıldığında sana @{handle} adını o verdi. Bunu sen seçmedin, şimdi seçebilirsin.',
    usernameHint: 'Harf, rakam ve alt çizgi. İnsanlar seni böyle bulur.',
    usernameEvery:
      'Bunu her {days} günde bir değiştirebilirsin. Eski kullanıcı adını taşıyan bağlantılar ve QR kodları, bir sonraki değişikliğe kadar çalışmaya devam eder.',
    usernameSave: 'Kullanıcı adını değiştir',
    usernameSaved: 'Artık @{handle} sensin.',
    usernameFailed: 'Kullanıcı adın değiştirilemedi. Tekrar dene.',
    usernameReserved: '@{handle} eski LangX’teki başka bir hesaba ait.',
    usernameCooldown: 'Şu an @{handle} sensin. Yeniden değiştirebileceğin tarih: {date}.',
    usernameConfirmTitle: 'Kullanıcı adın değişsin mi?',
    usernameConfirmBody: 'Artık @{handle} olacaksın. {days} gün geçmeden tekrar değiştiremezsin.',
    password: 'Şifre',
  ...
  tokenKind: {
    ...
    gift: 'Saatlik hediye',
    bounty: 'Hata ödülü',
    reportReward: 'Bildirim ödülü',
    echo: 'Echo oturumu',
  },

  cosmetics: {
    stickersPixel: 'Pixel stickerları',
