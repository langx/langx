...
export const tr: Localized<EnMessages> = {
  ...
  echo: {
    ...
    easy: 'Kolay',
    play: 'Oynat',
    packContains: 'İçindekiler',
    packRange: '{total} içinden {from}–{to}',
    packPagePrev: 'Önceki',
    packPageNext: 'Sonraki',
  ...
  settings: {
    ...
    username: 'Kullanıcı adı',
    usernameBody: 'Kendi adını seç, bir kez',
    usernameTitle: 'Kullanıcı adını seç',
    usernameIntro:
    ...
    usernameOnce:
      'Bunu bir kez yapabilirsin. Eski kullanıcı adını taşıyan bağlantılar ve QR kodları çalışmaya devam eder, o adı da kimse alamaz.',
    usernameSave: 'Bu adı al',
    ...
    usernameSpent: 'Kullanıcı adını seçtin: @{handle}. Bir daha değişmez.',
    password: 'Şifre',
