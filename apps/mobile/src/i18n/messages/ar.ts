...
export const ar: Localized<EnMessages> = {
  ...
  bugReport: {
    ...
    rowBody: 'هل هناك شيء معطّل؟ أخبرنا واكسب رموزًا مقابل ذلك.',
    intro:
      'اكتب ما حدث، وما كنت تتوقعه بدلًا منه، وكيف يتكرر الأمر. كلما كان وصفك أدق، أسرعنا في إصلاحه.',
    reward:
      'إذا تمكنّا من تكرار المشكلة وتأكدنا أنها خلل، تكسب رموزًا مقابل اكتشافها — وعددها يعتمد على مدى خطورتها.',
    placeholder: 'ما الذي حدث وما الذي كنت تتوقعه…',
    hint: 'لقطة شاشة أو تسجيل للشاشة يساعدان أكثر من أي شيء آخر. نردّ بالبريد على العنوان المسجَّل في حسابك.',
    send: 'إرسال البلاغ',
    sending: 'جارٍ الإرسال…',
    sent: 'شكرًا لك. نقرأ كل بلاغ ونردّ بالبريد.',
    failed: 'لم يُرسَل البلاغ. حاول مرة أخرى بعد قليل.',
  },
  kitchen: {
    title: 'مطبخنا',
