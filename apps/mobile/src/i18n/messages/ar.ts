...
export const ar: Localized<EnMessages> = {
  ...
  errors: {
    ...
    discordSignInFailed: 'تعذّر تسجيل الدخول بحساب Discord',
  ...
  auth: {
    ...
    continueWithDiscord: 'المتابعة باستخدام Discord',
  ...
  chat: {
    ...
    playbackRate: '{rate}×',
    playbackSpeed: 'سرعة التشغيل: {rate}×',
  ...
  howItWorks: {
    title: 'كيف يعمل LangX',
    featuresSection: 'ميزات التعلّم',
    gotIt: 'حسنًا',
    whatTitle: 'ما هو LangX',
    whatBody:
      'مكان تمارس فيه لغة مع من يتحدّثونها. كل من يُوفَّق بينك وبينه لغته الأم لغةٌ تتعلّمها أنت، وهو يتعلّم لغة تتحدّثها — تعلّمه لغتك ويعلّمك لغته، فيتحسّن كلاكما.',
    whatBody2: 'لا أحد هنا معلّم مدفوع الأجر. الجميع يتعلّم شيئًا، والجميع خبير في لغته.',
    helpTitle: 'كيف تساعد شريكك على التعلّم',
    helpBody: 'الشريك الجيد ليس الشريك المثالي، بل من يجعل الاستمرار سهلًا.',
    helpTakeTurns: 'تناوبا: بعض الوقت بلغته، وبعضه بلغتك.',
    helpCorrect: 'صحّح شيئًا أو اثنين في كل مرة، لا كل خطأ في الرسالة.',
    helpSimple: 'اكتب ببساطة، وتمهّل حين يطلب منك ذلك.',
    helpQuestions: 'اطرح أسئلة. كتابة الرد أسهل من كتابة الرسالة الأولى.',
    helpPatient: 'كن صبورًا. أنت أيضًا تتعلّم.',
    rulesTitle: 'سلوكيات غير مقبولة',
    rulesLead: 'LangX لممارسة اللغات. أيٌّ مما يلي قد يؤدي إلى تعليق الحساب أو حذفه نهائيًا.',
    rulesHarassment: 'التحرّش، أو الإلحاح بعد أن يتوقف أحدهم عن الرد',
    rulesHate: 'خطاب الكراهية والشتائم',
    rulesSexual: 'المحتوى الجنسي والتودّد غير المرغوب فيه — LangX ليس تطبيق مواعدة',
    rulesMinors: 'أي شيء يُضفي طابعًا جنسيًا على القاصرين',
    rulesImpersonation: 'انتحال شخصية أحد آخر، أو الكذب بشأن عمرك',
    rulesPrivate: 'نشر المعلومات الخاصة بشخص آخر',
    rulesSpam: 'الرسائل المزعجة والاحتيال والإعلانات وطلب المال',
    rulesTopics:
      'السياسة والدين ليسا ممنوعين — فاللغة لا تنفع كثيرًا إن لم تستطع أن تتحدّث بها إلا عن الطقس. الممنوع هو العداء تجاه شخص.',
    rulesBlock: 'الحظر يعمل فورًا ولا يُبلَّغ به الطرف الآخر. أما الإبلاغ فيصل إلينا.',
    rulesAccept: 'فهمت',
    rulesRead: 'اقرأ الإرشادات كاملة',
    holdTitle: 'اضغط مطوّلًا على رسالة',
    holdBody:
      'اضغط مطوّلًا على أي رسالة لترى ما يمكنك فعله بها. الرد أو التصحيح أو الترجمة أو النسخ أو حفظها في صدى — ما يظهر يعتمد على الرسالة ومن أرسلها.',
    correctTitle: 'صحّح ودع غيرك يصحّح لك',
    correctBody:
      'اضغط مطوّلًا على رسالة شريكك واختر «تصحيح». أصلح الخطأ وأرسلها: سيرى بالضبط ما الذي تغيّر. التصحيحات بلا حدود في كل الخطط.',
    translateTitle: 'ترجمة رسالة',
    translateBody:
      'اضغط مطوّلًا على رسالة واختر «ترجمة». تظهر الترجمة تحتها بلغتك، دون مغادرة المحادثة. إن كنت تتحدّث أكثر من لغة، فاختر إحداها من الإعدادات.',
    voiceTitle: 'الملاحظات الصوتية',
    voiceBody: 'اضغط على الميكروفون للتسجيل. استمع إليها قبل الإرسال — سماع الكلمة نصف تعلّمها.',
    ...
    discoverTitle: 'اعثر على شريك',
    discoverBody:
      'كل من في «استكشاف» يتحدّث لغة تتعلّمها ويتعلّم لغة تتحدّثها. «لك» مطابق للغاتك، و«نشطون» يعرض من كان هنا للتوّ، و«قريبون» يستخدم موقعك بعد أن تشاركه. افتح ملفًا شخصيًا وألقِ التحية — هكذا يبدأ كل تبادل تقريبًا هنا.',
    plusTitle: 'زر +',
    plusBody:
      'اضغط على + بجانب خانة الرسالة. إلى جانب الصور والملاحظات الصوتية، يمكنك أن تطلب تصحيحك، أو تسأل كيف يُنطق شيء وتتلقّى ملاحظة صوتية، أو تحفظ عبارة مع معناها، أو تقترح وقتًا للحديث، أو تطرح سؤالًا بإجابة صحيحة واحدة.',
    sendTranslationTitle: 'اكتب بلغته',
    sendTranslationBody:
      'اضغط على + واختر الإرسال بلغة شريكك أيضًا. اكتب بلغتك فتُرسَل الرسالتان معًا، فيقرؤك دون تخمين. هذه الميزة ضمن {plan}.',
  },
  ...
  paywall: {
    ...
    savingA11y: '{price} شهريًا في الخطة الشهرية. الاشتراك السنوي يوفّر {percent}%.',
