...
export const ar: Localized<EnMessages> = {
  ...
  discover: {
    ...
    boostedExplainBody:
      'يظهر هنا مشتركو Fluent وPolyglot، وPolyglot أولًا. يتغيّر الترتيب على مدار اليوم، فيأتي كلٌّ منهم في المقدمة بدوره. تتم مطابقتهم بلغاتك تمامًا مثل القائمة أدناه — لا يتغير شيء في المطابقة، ويمكن لأي شخص إيقافها من الإعدادات.',
