...
export const ar: Localized<EnMessages> = {
  ...
  echo: {
    ...
    markLearned: 'أعرف هذه',
    putItBack: 'أعدها',
    archived: 'محفوظة',
    archivedEmptyTitle: 'لم تحفظ شيئًا بعد',
    archivedEmptyBody: 'البطاقات التي تعرفها تأتي هنا. تحتفظ بكل شيء ولا تعود.',
    ...
    archivedToast: {
      ...
      one: 'حُفظت بطاقة',
      two: 'حُفظت بطاقتان',
      few: 'حُفظت {count} بطاقات',
      many: 'حُفظت {count} بطاقة',
      other: 'حُفظت {count} بطاقة',
    },
    restoredToast: {
      zero: 'لم تعد بطاقة',
      one: 'عادت بطاقة',
