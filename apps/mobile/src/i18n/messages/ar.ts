...
export const ar: Localized<EnMessages> = {
  ...
  echo: {
    ...
    aboutBody:
      'معظم ما تقابله اليوم يختفي خلال أسبوع — ما لم تقابله مرة أخرى. يعيد Echo الجملة قبل أن تفلت منك بقليل، وكلما تذكّرتها طالت المدة التالية.',
    ...
    aboutLittle:
      'اللغة آلاف الكلمات، وEcho لا يسألك إلا عمّا أوشكت على نسيانه؛ لذلك عشر دقائق يوميًا تقطع شوطًا أطول من ساعة أسبوعيًا.',
    aboutYours: 'ثم إنها جملك أنت، من محادثاتك أنت — كلمات كان لديك سبب لتذكّرها أصلًا.',
    aboutForgot: 'نسيتها؟ تعود بعد دقيقة وتبدأ من المدد القصيرة من جديد. لا شيء يضيع.',
    aboutProof:
      'التكرار المتباعد والاختبار الذاتي هما أكثر نتيجتين مُثبتتين في أبحاث الذاكرة منذ ثمانينيات القرن التاسع عشر. وهذا هو الاثنان معًا، موجَّهين إلى لغتك.',
    aboutClose: 'فهمت',
  },
