...
export const ar: Localized<EnMessages> = {
  ...
  tour: {
    ...
    tabChatsBody: 'كل محادثة تبدأها تعيش هنا، ومن ينتظر ردك يبقى في قائمة منفصلة.',
    tabChatsGuestBody:
      'المحادثات تجتمع هنا. يمكنك التصفح والقراءة دون حساب — الكتابة وحدها هي ما يحتاج إليه.',
    tabFeedTitle: 'اسأل الجميع',
    tabFeedBody:
      'انشر جملة لست واثقًا منها وسيصححها أحدهم. وتصحيح جملة غيرك هو أنفع دقيقة تقضيها هنا.',
    tabMeTitle: 'ما يخصك',
    tabMeBody: 'ملفك ورموزك والسلسلة التي أنت على وشك بدئها.',
