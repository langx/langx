...
export const ru: Localized<EnMessages> = {
  ...
  errors: {
    ...
    invalidCredentials:
      'Это не подходит ни к одному аккаунту. Войдите по почте или имени пользователя; если у вас был аккаунт в прежнем приложении, сбросьте пароль или продолжите через Google или Apple.',
