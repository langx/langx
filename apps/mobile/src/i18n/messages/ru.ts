...
export const ru: Localized<EnMessages> = {
  ...
  tabs: { discover: 'Поиск', chats: 'Чаты', echo: 'Эхо', feed: 'Лента', me: 'Я' },
  ...
  tips: {
    ...
    composerVoice: 'Нажмите микрофон, прослушайте, отправьте',
    ...
    chatVoice:
      'Нажмите микрофон для голосового — его можно прослушать перед отправкой, а услышать слово — половина дела.',
    ...
    discoverRadius:
      '«Рядом» идёт от ближайших наружу. Задай радиус в фильтрах, чтобы ограничить его.',
    ...
    chatEcho:
      'Задержи палец на сообщении и выбери «Добавить в Эхо». Оно вернётся завтра, потом через три дня, потом через неделю.',
    chatAttach:
      'Плюс рядом с полем ввода может попросить исправить, предложить время для разговора или задать вопрос.',
    chatsStarred: 'Звезда наверху открывает все сообщения, которые ты отметил, из всех чатов.',
    discoverActive: 'Сортируй по «Активные», чтобы увидеть, кто заходил недавно.',
    feedEcho: 'Задержи палец на посте, чтобы сохранить его фразу в Эхо.',
    feedSlowTake:
      'Отвечаешь на вопрос о произношении? Добавь и медленную запись — учатся именно по ней.',
    composerEcho: 'Удерживайте, чтобы сохранить в Эхо',
    echoAgain:
      'Забыл? Нажми «Снова», и карточка вернётся через десять минут, а не через дни. Ничего не пропадает.',
    echoAutoplay:
      'Динамик в шапке сессии проигрывает каждую карточку, как только она появляется. Нажми, чтобы выключить.',
    echoTyping:
      'Когда карточка уже закрепилась, каждое второе повторение просит написать её, а не просто узнать.',
    echoArchive:
      'Знаешь карточку наизусть? Убери её в архив из «Все карточки». Она сохранит всё и перестанет возвращаться.',
    echoOwn:
      'Напиши свою карточку из «Все карточки». Оставь значение пустым — его переведут за тебя.',
    echoRecord: 'Открой карточку, чтобы добавить картинку или записать её своим голосом.',
  },
  tour: {
    ...
    skip: 'Пропустить',
    discoverPairTitle: 'Совпадение в обе стороны',
    discoverPairBody:
      'Все на этом экране говорят на языке, который вы учите, и учат язык, на котором говорите вы. Нажмите на пару, чтобы изменить её.',
    discoverSortsTitle: 'Три способа смотреть',
    discoverSortsBody:
      'Для вас подбирает по вашим языкам, Активные показывает тех, кто только что был здесь, а Рядом работает, когда вы делитесь геопозицией.',
    discoverCardTitle: 'Начните отсюда',
    discoverCardBody:
    ...
    tabChatsGuestBody:
      'Разговоры хранятся здесь. Смотреть и читать можно без аккаунта — он нужен только чтобы написать.',
    tabFeedTitle: 'Спрашивайте и учитесь',
    tabFeedBody:
      'Лента — это вся комната: попросите поправить фразу, послушайте, как звучит слово, и сделайте то же для кого-то ещё.',
  },
  theme: {
    section: 'Оформление',
    label: 'Тема',
  ...
  echo: {
    ...
    allCaughtUp: 'Сейчас ничего не ждёт',
    review: 'Повторить',
    allLanguages: 'Все',
    added: 'Добавлено в Эхо',
    alreadyAdded: 'Уже в Эхе',
    removed: 'Убрано из Эха',
    addToEcho: 'Добавить в Эхо',
    removeFromEcho: 'Убрать из Эха',
    bubbleAdd: '+ Эхо',
    bubbleAdded: 'В Эхе',
    addFailedTitle: 'Не удалось добавить карточку',
    removeFailedTitle: 'Не удалось убрать карточку',
    limitTitle: 'Дневной предел Эха',
    limitBody: 'В день можно сохранить {count} карточек. Завтра счёт начнётся заново.',
    fromYourChats: 'Из ваших чатов',
    fromAPost: 'Из записи',
    fromYourself: 'Написано вами',
    seeAllCards: 'Все карточки',
    emptyTitle: 'Повторять пока нечего',
    emptyBody:
      'Задержите палец на сообщении в чате и выберите «Добавить в Эхо». Оно вернётся завтра, потом через три дня, потом через неделю.',
    emptyAction: 'К чатам',
    readyTitle: 'Когда будешь готов',
    tileDue: 'карточек ждут',
    readySub: 'Нажми, чтобы начать',
    nextIn: 'Следующая карточка вернётся через {time}',
    statToday: 'Сегодня',
    statWeek: 'За неделю',
    statCards: 'Карточки',
    ...
    packsEmptyTitle: 'Наборов пока нет',
    packsEmptyBody:
      'Наборы следуют за языками, которые ты учишь. Добавь язык в профиль — и здесь появится то, что у нас для него есть.',
    packTileSub: 'из {total} начато',
    statWords: 'Слова',
    statYours: 'У тебя',
    statReviews: 'Повторения',
    cardSource: 'Откуда она',
    ...
    cardsEmptyTitle: 'Карточек пока нет',
    cardsEmptyBody: 'Здесь собираются фразы из чатов и постов — и те, что вы пишете сами.',
    archiveCard: 'Убрать в архив',
    archiveCards: 'В архив',
    unarchive: 'Вернуть',
    activeTab: 'Карточки',
    archived: 'Архив',
    archivedEmptyTitle: 'В архиве пока пусто',
    archivedEmptyBody:
      'Сюда попадают карточки, которые вы уже знаете. Они сохраняют всё и не возвращаются, пока вы сами их не вернёте.',
    ...
    archivedToast: {
      one: '{count} карточка в архиве',
      few: '{count} карточки в архиве',
      many: '{count} карточек в архиве',
      other: '{count} карточек в архиве',
    },
    restoredToast: {
      one: '{count} карточка вернулась',
      few: '{count} карточки вернулись',
      many: '{count} карточек вернулось',
      other: '{count} карточек вернулось',
    },
    searchPlaceholder: 'Поиск по карточкам',
    searchNoneTitle: 'Ничего не найдено',
    searchNoneBody: 'Ни в одной карточке этого нет — ни во фразе, ни в значении, ни в примере.',
    dueIn: 'Через {time}',
    dueNow: 'Пора',
    remove: 'Убрать',
    removeTitle: 'Убрать эту карточку?',
    removeBody: 'Расписание уйдёт вместе с ней. Само сообщение останется на месте.',
    editTitle: 'Изменить карточку',
    editFront: 'Фраза',
    editBack: 'Что это значит',
    edited: 'Карточка обновлена',
    editFailedTitle: 'Не удалось сохранить карточку',
    cardMenu: 'Действия с карточкой',
    newTitle: 'Новая карточка',
    cardLanguage: 'Язык',
    backHint: 'Оставьте значение пустым — мы переведём его за вас.',
    reviewWhich: 'Какой язык?',
    cardPhoto: 'Изображение',
    addPhoto: 'Добавить изображение',
    replacePhoto: 'Заменить изображение',
    removePhoto: 'Убрать изображение',
    cardAudio: 'Запись',
    recordIt: 'Скажите сами',
    removeAudio: 'Убрать запись',
    sessionProgress: '{done} из {total}',
    show: 'Показать ответ',
    again: 'Снова',
    hard: 'Трудно',
    good: 'Хорошо',
    ...
    voiceFemale: 'Синтезированный · женский',
    voiceMale: 'Синтезированный · мужской',
    voiceSynthesised: 'Синтезированный',
    readAloud: 'Озвучить',
    readAloudFailedTitle: 'Не удалось озвучить карточку',
    readAloudLimitBody: 'В день можно озвучить {count} карточек. Завтра счёт начнётся заново.',
    spokenBy: 'Произносит {name}',
    askToHearIt: 'Спросить в ленте, как это произносится',
    keepOnCard: 'Сохранить на карточке',
    audioAlreadyKept: 'На карточке',
    audioKept: 'Сохранено на карточке',
    askForCorrection: 'Попросить в ленте исправить',
    keepCorrection: 'Сохранить как мою фразу',
    correctionKept: 'Теперь на карточке это',
    seeCard: 'Открыть карточку',
    cardTitle: 'Карточка',
    nextReview: 'Следующий повтор',
    sessionEmptyTitle: 'Ничего не ждёт',
    sessionEmptyBody: 'Загляните позже или сохраните фразу из чата.',
    doneTitle: 'Занятие завершено',
    doneReviewed: 'Повторено',
    doneRemembered: 'Вспомнили',
    doneAgain: 'Снова',
    ...
    check: 'Проверить',
    yourAnswer: 'Вы написали',
    verdictExact: 'В точку',
    verdictClose: 'Верно, с точностью до знака',
    verdictWrong: 'Не совсем',
    aboutOpen: 'Что это?',
    aboutTitle: 'Как работает Echo',
    aboutBody:
      'Echo возвращает фразу прямо перед тем, как ты её забудешь. Вспомнил — следующий перерыв длиннее.',
    aboutWithout: 'Без повторения',
    aboutWith: 'С Echo',
    aboutChart:
      'Две кривые за неделю. Без повторения запомненное падает почти до нуля. С Echo каждое повторение поднимает его обратно, и забывание с каждым разом идёт медленнее.',
    aboutLadder: 'Перерывы настоящие',
    aboutStep10m: '10 минут',
    aboutStep1d: '1 день',
    aboutStep3d: '3 дня',
    aboutStep8d: '8 дней',
    aboutStep20d: '20 дней',
    aboutStepMore: 'потом месяцы, потом раз в год',
    aboutRecall: 'Вопрос работает лучше, чем перечитывание.',
    aboutLittle: 'Десять минут в день лучше часа раз в неделю.',
    aboutYours: 'Твои собственные фразы из твоих переписок.',
    aboutForgot: 'Забыл? Вернётся раньше. Ничего не теряется.',
    aboutProof:
  ...
  errors: {
    ...
    discordSignInFailed: 'Не удалось войти через Discord',
    ...
    userExists:
      'Для этого e-mail уже есть аккаунт. Войдите, пришлите себе ссылку для входа, сбросьте пароль или продолжите через Google или Apple.',
  ...
  location: {
    ...
    guide: {
      ...
      rowTitle: 'Разрешение на геолокацию',
      rowBody: 'Где его включить и что делать, если телефон перестал спрашивать.',
      grantedTitle: 'Геолокация включена',
      grantedBody:
        'LangX может считывать примерное местоположение, пока вы пользуетесь приложением. Отозвать это можно в любой момент в настройках устройства.',
      askableTitle: 'LangX нужна ваша геолокация',
      askableBody:
        '«Рядом» сортирует людей по примерному расстоянию. Ничего точного не хранится, и никто не видит больше приблизительной дистанции.',
      allow: 'Разрешить геолокацию',
      blockedTitle: 'Устройство больше не спросит',
      blockedBody:
        'В геолокации для LangX было отказано, поэтому приложение больше не может показать запрос разрешения. Выдать его по-прежнему можно в настройках устройства.',
      iosStep1: 'Откройте «Настройки»',
      iosStep2: 'Найдите LangX в списке',
      iosStep3: 'Нажмите «Геопозиция» и выберите «При использовании»',
      androidStep1: 'Откройте «Настройки»',
      androidStep2: 'Перейдите в «Приложения» → LangX',
      androidStep3: 'Нажмите «Разрешения» → «Местоположение»',
      androidStep4: 'Выберите «Разрешить только во время использования приложения»',
      servicesOffTitle: 'Геолокация выключена на этом устройстве',
      servicesOffBodyIos:
        'У LangX есть разрешение, но службы геолокации выключены для всего телефона. Включите их в «Настройки» → «Конфиденциальность и безопасность» → «Службы геолокации».',
      servicesOffBodyAndroid:
        'У LangX есть разрешение, но геолокация выключена для всего устройства. Включите её в «Настройки» → «Местоположение».',
      webTitle: 'Здесь решает браузер',
      webBody:
        'Разрешение на геолокацию принадлежит браузеру, а не LangX. Найдите значок геолокации в адресной строке или разрешите её в настройках этого сайта.',
      howTo: 'Как включить',
    },
  },
  ...
  suspended: {
    ...
    untilBody:
      'Жалобу на ваш аккаунт рассмотрел человек. Вы не можете пользоваться LangX до {until}, а ваш профиль скрыт из поиска и подбора.',
    permanentBody:
    ...
    appealBody:
      'Вы можете подать апелляцию один раз. Её читает человек, никакой очереди отслеживать не нужно — ответ придёт на почту.',
    appealPlaceholder: 'Напишите, в чём мы ошиблись.',
    appealTooShort: {
      one: 'Минимум {count} символ.',
      other: 'Минимум {count} символов.',
    },
    send: 'Отправить апелляцию',
    sending: 'Отправляем…',
    sent: 'Апелляция отправлена',
    sentBody:
      'Апелляция отправлена. Она одна на блокировку, так что это была она — мы вам ответим.',
    failed: 'Не удалось отправить. Попробуйте через минуту.',
    alreadyAppealed: 'Вы уже подали апелляцию по этой блокировке.',
    checkAgain: 'Проверить снова',
    signOut: 'Выйти',
    contact: 'По любым другим вопросам: {email}',
  },
  ...
  auth: {
    ...
    signInWithLink: 'Прислать ссылку для входа',
    signInLinkTitle: 'Войти по ссылке',
    signInLinkBody:
      'Введите e-mail или имя пользователя, и мы пришлём ссылку, которая вас впустит — без пароля.',
    sendSignInLink: 'Прислать ссылку для входа',
    signInLinkSentBody:
      'Если для {email} есть аккаунт, ссылка для входа уже в пути. Она работает один раз и истекает через 15 минут.',
    signInLinkExpiredBody:
      'Эта ссылка для входа уже использована или истекла. Запросите новую и нажмите её в течение 15 минут.',
    openLinkTitle: 'Войти в LangX',
    openLinkBody:
  ...
  onboarding: {
    ...
    photoBody:
      'Мы нарисовали тебе лицо. С настоящим фото писать тебе будут гораздо чаще — а описание тоже необязательно.',
    drawnFace: 'Нарисовано для тебя. Останется, пока его не заменит фото.',
  ...
  welcomeBack: {
    ...
    streak: {
      one: 'серия из {count} дня, всё ещё идёт',
      few: 'серия из {count} дней, всё ещё идёт',
      many: 'серия из {count} дней, всё ещё идёт',
      other: 'серия из {count} дня, всё ещё идёт',
    },
    streakBody: 'Она вернулась живой, а не рекордом. Загляни завтра, и она сохранится.',
  ...
  notifications: {
    ...
    guide: {
      ...
      rowTitle: 'Разрешение на уведомления',
      rowBody: 'Где включить уведомления и что делать, если телефон перестал спрашивать.',
      grantedTitle: 'Уведомления включены',
      grantedBody:
        'Этот телефон может получать уведомления от LangX. Какие именно — список на предыдущем экране; отозвать разрешение можно в любой момент в настройках устройства.',
      askableTitle: 'LangX пока не может вас уведомлять',
      askableBody:
        'Когда приходит сообщение, вечернее напоминание, если серия вот-вот прервётся, и раз в день — сколько людей смотрели ваш профиль. Пока вы читаете чат, ничего не отправляется.',
      allow: 'Разрешить уведомления',
      blockedTitle: 'Устройство больше не спросит',
      blockedBody:
        'В уведомлениях для LangX было отказано, поэтому приложение больше не может показать запрос разрешения. Включить их по-прежнему можно в настройках устройства.',
      iosStep1: 'Откройте «Настройки»',
      iosStep2: 'Найдите LangX в списке',
      iosStep3: 'Нажмите «Уведомления» и включите «Допуск уведомлений»',
      androidStep1: 'Откройте «Настройки»',
      androidStep2: 'Перейдите в «Приложения» → LangX',
      androidStep3: 'Нажмите «Уведомления»',
      androidStep4: 'Включите «Все уведомления LangX»',
      silencedTitle: 'Отключены на этом телефоне',
      silencedBody:
        'Устройство разрешает уведомления, но в LangX они выключены для этого телефона. Включите «Уведомления на этом телефоне» экраном выше — ваши другие устройства это не затрагивает ни в том, ни в другом случае.',
      webTitle: 'В браузере push не приходит',
      webBody:
        'Уведомления доходят до вас в приложении LangX для iPhone или Android. Здесь включать нечего.',
      openSettings: 'Открыть настройки',
    },
  },
  ...
  corrections: {
    ...
    emptyBody:
      'Задержи палец на сообщении и выбери «Исправить» или исправь фразу из ленты — это самое полезное, что тут можно сделать.',
  ...
  discover: {
    pickTitle: 'Никто не выбран',
    pickBody: 'Выберите человека в списке — его профиль откроется здесь.',
    boosted: 'Продвигаемые',
    boostedWhat: 'Что это?',
    boostedExplainTitle: 'Продвигаемые профили',
    boostedExplainBody:
      'Здесь показываются участники с Fluent и Polyglot, сначала Polyglot. Порядок меняется в течение дня, так что каждый побывает первым, — вперёд выводят фотография, пара слов о себе и недавний визит. Они подобраны по языкам точно так же, как список ниже, — в подборе ничего не меняется, и это можно отключить в настройках.',
    boostedSeePlans: 'Посмотреть планы',
    languagesA11y: 'Выберите, с какими из ваших языков искать',
    searchHandles: 'Поиск по имени или имени пользователя',
    searchPlaceholder: 'Имя или имя пользователя',
    searchNone: 'Аккаунта с таким именем или именем пользователя нет.',
    ...
    nobodySharingTitle: 'Пока никто не делится геопозицией',
    nobodySharingBody:
      '«Рядом» показывает только тех, кто включил геолокацию. Попробуй другую вкладку.',
    nearbyNeedsPermissionTitle: 'Для «Рядом» нужна геолокация',
    nearbyNeedsPermissionBody:
      'Разрешение на геолокацию не выдано, поэтому сортировать по расстоянию нечего.',
    nearbyServicesOffTitle: 'Геолокация выключена на этом устройстве',
    nearbyServicesOffBody: '«Рядом» не заработает, пока геолокация не будет включена снова.',
    nearbyUnavailableTitle: 'Не удалось вас найти',
    nearbyUnavailableBody: 'Сейчас координаты не пришли. Попробуйте через минуту.',
  ...
  filters: {
    learns: 'Учит',
    learnsBody: 'Какой из ваших языков должен учить собеседник.',
    title: 'Фильтры',
    speaks: 'Говорит',
    city: 'Город',
    cityNeedsLocation:
    ...
    distance: 'Расстояние',
    distanceBody:
      'Ограничивает, как далеко смотрит «Рядом». Без ограничения список идёт от ближайших наружу.',
    distanceKm: '{km} км',
    practiseBody:
  ...
  chats: {
    ...
    deleted: 'Чат удалён',
    unreadNew: { one: '{count} новое', other: '{count} новых' },
    tab_all: 'Все',
    ...
    pickTitle: 'Разговор не выбран',
    pickBody: 'Выберите его в списке — он откроется здесь.',
  ...
  chat: {
    ...
    askingPronunciationHint: 'Напиши фразу — ответить можно голосовым.',
    askCorrection: 'Попросить исправить',
    askPronunciation: 'Спросить, как это произносится',
    askBadgeCorrection: 'Просит исправить',
    askBadgePronunciation: 'Хочет услышать',
    askAnswerCorrect: 'Исправить',
    askAnswerSay: 'Произнести',
    sendTranslatedOn: 'Отправлять и на {language}',
    sendTranslatedOff: 'Не отправлять перевод',
    sendTranslatedBanner: 'Уйдёт и на {language}',
    sendTranslatedHint: 'Пиши на своём языке — уйдут оба.',
    sendTranslatedFailed: 'Перевести не удалось — сообщение ушло как есть.',
    ...
    quizQuestion: 'Вопрос',
    quizOption: 'Вариант {number}',
    quizCorrect: 'Какой из них верный?',
    quizNeedsOptions: 'Впиши хотя бы два варианта и отметь верный.',
    meetingAccept: 'Принять',
    meetingDecline: 'Отклонить',
    meetingCancel: 'Отозвать',
    ...
    sendPhrase: 'Сохранить выражение',
    sendMeeting: 'Предложить время',
    phraseTerm: 'Слово или выражение',
    phraseMeaning: 'Что это значит',
    phraseExample: 'Пример (необязательно)',
    phraseSaved: 'Выражение сохранено.',
    phraseDeck: 'Сохранённые выражения',
    phraseDeckEmpty: 'Здесь пока пусто.',
    deckExport: 'Экспорт',
    deckExportFailed: 'Отсюда не удалось сохранить файл.',
    meetingNote: 'Заметка (необязательно)',
    meetingWhenLabel: 'Когда',
    ...
    playbackRate: '{rate}×',
    playbackSpeed: 'Скорость воспроизведения: {rate}×',
  ...
  inbox: {
    ...
    postComment: '{name} прокомментировал вашу запись',
    postCorrection: '{name} исправил ваше предложение',
    pronunciationAnswer: '{name} записал ваше предложение',
    like: '{name} оценил вашу запись',
    likeOthers: {
      one: '{name} и ещё {count} человек оценили вашу запись',
    ...
    walletPool: {
      ...
      few: 'Вчерашний банк принёс вам {count} жетона',
      many: 'Вчерашний банк принёс вам {count} жетонов',
      other: 'Вчерашний банк принёс вам {count} жетона',
    },
    profileVisits: {
      one: '{count} человек посмотрел ваш профиль',
      few: '{count} человека посмотрели ваш профиль',
  ...
  profile: {
    ...
    badgeStrip: {
      ...
      many: '{count} значков заработано',
      other: '{count} значка заработано',
    },
  ...
  me: {
    ...
    proBody: 'Безлимитные новые чаты, расширенные фильтры, переводы и два языка сразу.',
  ...
  howItWorks: {
    title: 'Как устроен LangX',
    featuresSection: 'Функции для учёбы',
    gotIt: 'Понятно',
    whatTitle: 'Что такое LangX',
    whatBody:
      'Место, где язык практикуют с теми, кто на нём говорит. Каждый, с кем ты совпадаешь, — носитель языка, который ты учишь, и сам учит язык, на котором говоришь ты: ты учишь его своему, он тебя — своему, и оба становитесь лучше.',
    whatBody2:
      'Здесь нет платных преподавателей. Каждый что-то учит, и каждый — эксперт в своём родном языке.',
    helpTitle: 'Как помочь партнёру учиться',
    helpBody: 'Хороший партнёр — не идеальный, а тот, с кем легко продолжать.',
    helpTakeTurns: 'Чередуйте: часть времени на его языке, часть — на твоём.',
    helpCorrect: 'Исправляй одну-две вещи за раз, а не каждую ошибку в сообщении.',
    helpSimple: 'Пиши просто и помедленнее, когда тебя об этом просят.',
    helpQuestions: 'Задавай вопросы. Ответить легче, чем написать первое сообщение.',
    helpPatient: 'Будь терпелив. Ты ведь тоже учишься.',
    rulesTitle: 'Недопустимое поведение',
    rulesLead:
      'LangX — для практики языка. Любое из этого может привести к блокировке аккаунта или его удалению навсегда.',
    rulesHarassment: 'Преследование или настойчивость, когда человек перестал отвечать',
    rulesHate: 'Язык вражды и оскорбления',
    rulesSexual: 'Сексуальный контент и непрошеные ухаживания — LangX не сайт знакомств',
    rulesMinors: 'Всё, что сексуализирует несовершеннолетних',
    rulesImpersonation: 'Выдавать себя за другого или лгать о своём возрасте',
    rulesPrivate: 'Публиковать чужую личную информацию',
    rulesSpam: 'Спам, мошенничество, реклама и просьбы о деньгах',
    rulesTopics:
      'Политика и религия не под запретом — язык мало на что годится, если на нём можно говорить только о погоде. Под запретом враждебность к человеку.',
    rulesBlock: 'Блокировка срабатывает сразу, и человек об этом не узнаёт. Жалоба уходит нам.',
    rulesAccept: 'Я понимаю',
    rulesRead: 'Прочитать правила целиком',
    holdTitle: 'Задержи палец на сообщении',
    holdBody:
      'Задержи палец на любом сообщении, чтобы увидеть, что с ним можно сделать. Ответить, исправить, перевести, скопировать или сохранить в Эхо — что доступно, зависит от сообщения и от того, кто его отправил.',
    correctTitle: 'Исправляй и позволь исправить себя',
    correctBody:
      'Задержи палец на сообщении партнёра и выбери «Исправить». Поправь ошибки и отправь: он увидит, что именно изменилось. Исправления безлимитны на любом тарифе.',
    translateTitle: 'Перевести сообщение',
    translateBody:
      'Задержи палец на сообщении и выбери «Перевести». Перевод появится под ним, на твоём языке, не выходя из чата. Если ты говоришь на нескольких, выбери нужный в Настройках.',
    voiceTitle: 'Голосовые сообщения',
    voiceBody:
      'Нажми на микрофон, чтобы записать. Прослушай перед отправкой — услышать слово уже половина дела.',
    echoTitle: 'Сохрани в Эхо',
    echoBody:
      'Задержи палец на сообщении и выбери «Добавить в Эхо». Фраза вернётся во вкладке Эхо как раз перед тем, как ты её забудешь, — пока ты её не запомнишь.',
    feedTitle: 'Спроси в Ленте',
    feedBody:
      'Опубликуй фразу, чтобы её исправили, или спроси, как произносится слово, и кто-нибудь его запишет. А потом сделай то же для другого.',
    streakTitle: 'Серии и жетоны',
    streakBody:
      'Одно сообщение в день сохраняет серию. За общение и обучение дают жетоны — их можно потратить на заморозку серии или на новое оформление профиля.',
    discoverTitle: 'Найди партнёра',
    discoverBody:
      'Все в Поиске говорят на языке, который ты учишь, и учат язык, на котором говоришь ты. «Для тебя» подобрано под твои языки, «Активные» — кто был здесь только что, а «Рядом» работает, когда ты поделишься местоположением. Открой профиль и поздоровайся — так здесь начинается почти любой обмен.',
    plusTitle: 'Кнопка +',
    plusBody:
      'Нажми + рядом с полем сообщения. Кроме фото и голосовых, можно попросить исправить тебя, спросить, как что-то произносится, и получить голосовое в ответ, сохранить выражение вместе с его значением, предложить время для разговора или задать вопрос с одним правильным ответом.',
    sendTranslationTitle: 'Пиши на его языке',
    sendTranslationBody:
      'Нажми + и выбери отправку ещё и на языке партнёра. Пиши на своём — уйдут оба варианта, и он поймёт тебя без догадок. Это входит в {plan}.',
  },
  ...
  editProfile: {
    ...
    photoUploading: 'Загрузка фото, {percent} %',
    photoRetry: 'Это фото не загрузилось. Нажми, чтобы повторить, или удерживай, чтобы убрать.',
    photoRetryShort: 'Повторить',
    photoLimit: 'Можно добавить до {max} фотографий.',
    photosTrimmed: 'В галерее помещается {max} фотографий, поэтому добавились не все.',
  ...
  languages: {
    title: 'Твои языки',
    nativeSection: 'Родные',
    nativeBody: 'Языки, на которых ты вырос. Так тебя находят те, кто их учит.',
    learningSection: 'Изучаемые',
    learningBody: 'Что ты учишь. Первый идёт во главе профиля.',
    addNative: 'Добавить родной язык',
    addLearning: 'Добавить изучаемый язык',
    pickNativeTitle: 'Родной язык',
    pickLearningTitle: 'Изучаемый язык',
    replaceTitle: 'Заменить {language}',
    replaceBody: 'Выбери язык, который займёт его место.',
    startsAtNew: 'Начинается с первого уровня. Потом можно изменить.',
    alreadyInList: '{language} уже в твоём списке.',
    ...
    lastLearning: 'Нужен хотя бы один изучаемый язык. Замени этот, а не убирай.',
    capReached: {
      one: 'Твой тариф вмещает {count} язык в этом списке.',
      few: 'Твой тариф вмещает {count} языка в этом списке.',
      many: 'Твой тариф вмещает {count} языков в этом списке.',
      other: 'Твой тариф вмещает {count} языка в этом списке.',
    },
    capReachedShort: {
      one: 'Твой тариф вмещает {count} язык.',
      few: 'Твой тариф вмещает {count} языка.',
      many: 'Твой тариф вмещает {count} языков.',
      other: 'Твой тариф вмещает {count} языка.',
    },
    capUpgrade: '{fluent} вмещает {fluentMax}, {polyglot} — {polyglotMax}.',
    capOverGrandfathered:
      'У тебя уже больше, чем вмещает тариф. Их можно менять и убирать, но не добавлять новые.',
    changeHint: 'Нажми на язык, чтобы заменить его.',
    saveFailed: 'Не сохранилось. Ничего не изменилось.',
  },
  ...
  feedback: {
    ...
    tooMany: 'Вы уже отправили несколько. Попробуйте снова через час.',
    tooShort: {
      one: 'Ещё немного — минимум один символ.',
      other: 'Ещё немного — минимум {count} символов.',
    },
  },
  kitchen: {
    title: 'Наша кухня',
  ...
  streak: {
    ...
    protectTitle: 'Защити серию',
    protectBody:
      'Заморозка закрывает следующий пропущенный день. Уже пропущенный день можно выкупить на карте выше в течение месяца.',
    longest: 'Рекорд',
    missed: 'Пропущено',
  ...
  settings: {
    scanBody: 'Войти на компьютере или открыть профиль друга',
    ...
    appearanceBody: 'Тема, значок приложения, язык и подсказки',
    accountBody: 'Как вы входите, устройства, заблокированные, ваши данные',
    signInMethods: 'Способы входа',
    signInMethodsBody: 'Как вы попадаете в аккаунт',
    signInIdentifiers: 'Войти можно любым из них:',
    signInPasswordTitle: 'Пароль',
    signInPasswordSet: 'Задан',
    signInPasswordNotSet: 'Не задан',
    signInSetPassword: 'Задать пароль',
    signInSetPasswordBody: 'Чтобы входить без Google и Apple.',
    ...
    changePasswordSaved: 'Пароль изменён.',
    changePasswordFailed: 'Не удалось изменить пароль. Попробуйте ещё раз.',
    currentPasswordWrong: 'Это не ваш текущий пароль.',
    signInConnected: 'Связанные аккаунты',
    signInConnectedSince: 'Связан {date}',
    signInNoneConnected: 'Ничего не связано',
    signInOnlyProvider: 'Это ваш единственный вход. Задайте пароль, чтобы не потерять доступ.',
    aboutSection: 'О приложении',
    aboutBody: 'Юридическое, сообщество и вступление',
    search: 'Поиск по настройкам',
    searchNone: 'Ни одна настройка не подходит.',
    ...
    voiceCreditsEngines: 'Движки — Kokoro-82M и Piper, оба с открытым исходным кодом.',
    ...
    hideCityBody:
      'Твой город и часовой пояс определяются по местоположению. Это убирает оба из профиля; расстояние и страна не меняются.',
    shareLocation: 'Делиться примерным местоположением',
    shareLocationBody: 'Другие видят диапазон расстояния, а не точку.',
    shareUsage: 'Делиться данными об использовании',
    shareUsageBody:
      'Какие экраны и кнопки используются, и запись экрана, на которой скрыты все слова и изображения, — но никогда то, что вы пишете. Так мы видим, где люди застревают.',
    ...
    showTour: 'Повторить экскурсию',
    showTourBody: 'Пройдите по экрану «Поиск» ещё раз, шаг за шагом.',
  ...
  store: {
    ...
    bought: '{title} — твой',
    notEnoughTitle: 'Не хватает жетонов',
    notEnoughBody: '{title} стоит {price}. У тебя {balance}.',
  ...
  invite: {
    ...
    step4:
      'Они тоже получают: ещё {invitee} в тот же момент, то есть с бонусом за регистрацию начинают с {total}.',
    totalsInvited: {
      one: 'приглашён',
      few: 'приглашено',
      many: 'приглашено',
  ...
  scan: {
    ...
    body: 'Наведите камеру на код входа на компьютере или на код профиля друга.',
    permissionTitle: 'Нужен доступ к камере',
    permissionBody: 'LangX нужна камера, чтобы прочитать код. Ничего не записывается.',
    allow: 'Разрешить камеру',
    openSettings: 'Открыть настройки',
    unknown: 'Это не код LangX.',
    webOnly:
      'Для сканирования нужна камера телефона. Откройте LangX на телефоне и нажмите «Сканировать код» в настройках.',
  ...
  qrSignIn: {
    ...
    scanPath: 'Я → Настройки → Сканировать код',
