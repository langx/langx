...
export const ru: Localized<EnMessages> = {
  ...
  echo: {
    ...
    markLearned: 'Это я знаю',
    putItBack: 'Вернуть',
    archived: 'Выучено',
    archivedEmptyTitle: 'Пока ничего не отложено',
    archivedEmptyBody:
      'Сюда попадают карточки, которые вы уже знаете. Они сохраняют всё и больше не возвращаются.',
    ...
    archivedToast: {
      one: '{count} карточка отложена',
      few: '{count} карточки отложены',
      many: '{count} карточек отложено',
      other: '{count} карточек отложено',
    },
    restoredToast: {
