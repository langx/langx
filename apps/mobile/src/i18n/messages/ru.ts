...
export const ru: Localized<EnMessages> = {
  ...
  settings: {
    ...
    voiceCreditsBody: 'Сообщения читают вслух голосовые модели с открытым исходным кодом. Большинство ничего от нас не требует; эти десять лицензированы при условии, что мы укажем тех, кто их записал.',
