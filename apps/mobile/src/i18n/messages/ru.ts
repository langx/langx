...
export const ru: Localized<EnMessages> = {
  ...
  tour: {
    ...
    discoverFiltersTitle: 'Сузьте список',
    discoverFiltersBody:
      'Фильтруйте по уровню, возрасту или стране — или ищите по имени, если уже знаете, кто вам нужен.',
    ...
    tabMeTitle: 'Ваше',
    tabMeBody: 'Ваш профиль, токены и серия — а настройки прячутся за шестерёнкой.',
    sayHi: 'Поздоровайтесь с {name}',
    notNow: 'Не сейчас',
    feedAskTitle: 'Спросите об одном',
    feedAskBody:
      'Выложите фразу, в которой сомневаетесь, или слово, которое не выговорить, и пусть вам ответят.',
    feedKindsTitle: 'Два вида помощи',
    feedKindsBody:
      'Исправления пишут: кто-то поправит вашу фразу. Произношение говорят: кто-то запишет слово для вас.',
  },
  theme: {
    section: 'Оформление',
    label: 'Тема',
  ...
  scan: {
    ...
    webOnly:
      'Для сканирования нужна камера телефона. Откройте LangX на телефоне и нажмите значок сканирования в профиле.',
