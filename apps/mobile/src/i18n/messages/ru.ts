...
export const ru: Localized<EnMessages> = {
  ...
  discover: {
    ...
    boostedExplainBody:
      'Здесь показываются участники с Fluent и Polyglot, сначала Polyglot. Они подобраны по языкам точно так же, как список ниже, — в подборе ничего не меняется, и это можно отключить в настройках.',
