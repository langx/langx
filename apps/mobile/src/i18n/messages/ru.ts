...
export const ru: Localized<EnMessages> = {
  ...
  tour: {
    ...
    tabChatsBody:
      'Каждый начатый разговор живёт здесь, а те, кто ещё ждёт вашего ответа, вынесены отдельно.',
    tabChatsGuestBody:
      'Разговоры хранятся здесь. Смотреть и читать можно без аккаунта — он нужен только чтобы написать.',
    tabFeedTitle: 'Спросите у всех',
    tabFeedBody:
      'Выложите фразу, в которой сомневаетесь, и её поправят. Поправить чужую — самая полезная минута, которую здесь можно провести.',
    tabMeTitle: 'Ваше',
    tabMeBody: 'Ваш профиль, ваши токены и серия, которую вы вот-вот начнёте.',
