...
export const ru: Localized<EnMessages> = {
  ...
  echo: {
    ...
    aboutBody:
      'Карточка возвращается прямо перед тем, как ты её забудешь. Каждый раз, когда ты её вспоминаешь, следующий перерыв становится длиннее — фраза, сохранённая сегодня, останется с тобой и через месяц.',
    aboutLadder: 'Если ты продолжаешь её вспоминать',
    aboutChart:
      'Перерыв растёт с каждым разом: десять минут, день, три дня, восемь дней, двадцать дней.',
    ...
    aboutWhy: 'Это интервальное повторение: десять минут в день полезнее часа раз в неделю.',
    aboutClose: 'Понятно',
  },
