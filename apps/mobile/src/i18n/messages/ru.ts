...
export const ru: Localized<EnMessages> = {
  ...
  bugReport: {
    ...
    rowBody: 'Что-то сломалось? Расскажите нам и получите за это жетоны.',
    intro:
    ...
    reward:
      'Если нам удастся воспроизвести ошибку и подтвердить её, вы получите жетоны за находку — сколько именно, зависит от того, насколько она серьёзна.',
    placeholder: 'Что произошло и чего вы ждали…',
    hint: 'Скриншот или запись экрана помогают больше всего. Мы отвечаем письмом на адрес, указанный в вашем аккаунте.',
    send: 'Отправить сообщение',
    sending: 'Отправляем…',
    sent: 'Спасибо. Мы читаем каждое сообщение и отвечаем по почте.',
