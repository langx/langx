...
export const fr: Localized<EnMessages> = {
  ...
  echo: {
    ...
    easy: 'Facile',
    play: 'Écouter',
    packContains: "Ce qu'il contient",
    packRange: '{from}–{to} sur {total}',
    packPagePrev: 'Précédent',
    packPageNext: 'Suivant',
    ...
    replaceCardAudio: 'Remplacer l’enregistrement de ma carte',
