...
export const fr: Localized<EnMessages> = {
  ...
  discover: {
    ...
    boostedExplainBody:
      'Les membres Fluent et Polyglot apparaissent ici, Polyglot en premier. L’ordre tourne au fil de la journée, pour que chacun passe en tête. Ils sont associés à tes langues exactement comme la liste ci-dessous — rien ne change dans l’appariement, et chacun peut le désactiver dans les réglages.',
