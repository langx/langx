...
export const fr: Localized<EnMessages> = {
  ...
  tabs: { discover: 'Découvrir', chats: 'Discussions', echo: 'Echo', feed: 'Fil', me: 'Moi' },
  ...
  echo: {
    title: 'Echo',
    due: {
      one: '{count} carte à revoir',
      other: '{count} cartes à revoir',
    },
    allCaughtUp: 'Rien à revoir pour l’instant',
    review: 'Réviser',
    allLanguages: 'Toutes',
    added: 'Ajoutée à Echo',
    alreadyAdded: 'Déjà dans Echo',
    removed: 'Retirée d’Echo',
    addToEcho: 'Ajouter à Echo',
    removeFromEcho: 'Retirer d’Echo',
    bubbleAdd: '+ Echo',
    bubbleAdded: 'Dans Echo',
    addFailedTitle: 'Impossible d’ajouter cette carte',
    removeFailedTitle: 'Impossible de retirer cette carte',
    limitTitle: 'Limite quotidienne d’Echo atteinte',
    ...
    reviewWhich: 'Quelle langue ?',
    cardPhoto: 'Image',
    addPhoto: 'Ajouter une image',
    replacePhoto: 'Remplacer l’image',
    removePhoto: 'Retirer l’image',
    cardAudio: 'Enregistrement',
    recordIt: 'Dis-le toi-même',
    ...
    voiceFemale: 'Synthétique · féminine',
    voiceMale: 'Synthétique · masculine',
    voiceSynthesised: 'Synthétique',
    ...
    sessionEmptyTitle: 'Rien à revoir',
    sessionEmptyBody: 'Reviens plus tard, ou garde une phrase d’une de tes discussions.',
    doneTitle: 'Séance terminée',
    doneReviewed: 'Revues',
    doneRemembered: 'Retenues',
    doneAgain: 'À revoir',
  ...
  errors: {
    ...
    discordSignInFailed: 'Connexion Discord impossible',
  ...
  discover: {
    ...
    searchNone: 'Aucun compte avec ce nom ou ce nom d’utilisateur.',
    sortLabel: 'Tri',
    forYou: 'Pour toi',
    title: 'Découvrir',
    active: 'Actifs',
  ...
  chat: {
    ...
    suspendedOnly: 'Ce compte est suspendu. Tu ne peux pas lui envoyer de messages.',
    ...
    playbackRate: '{rate}×',
    playbackSpeed: 'Vitesse de lecture : {rate}×',
    ...
    wordTranslationFailed: 'Impossible de traduire ce mot pour le moment.',
    wordSeePlans: 'Voir les formules',
  ...
  editProfile: {
    ...
    usernameEvery: 'Vous pouvez le changer une fois tous les {days} jours.',
    usernameCooldown: 'Vous pourrez le changer à nouveau le {date}.',
    pronouns: 'Pronoms',
  ...
  settings: {
    ...
    username: 'Nom d’utilisateur',
    usernameBody: 'Modifiable tous les {days} jours',
    usernameTitle: 'Changer de nom d’utilisateur',
    usernameIntro: 'Tu es @{handle}. Choisis le nom d’utilisateur que tu veux à la place.',
    usernameIntroV1:
    ...
    usernameEvery:
      'Tu peux le changer une fois tous les {days} jours. Les liens et QR codes avec ton ancien nom continuent de fonctionner jusqu’au prochain changement.',
    usernameSave: 'Changer de nom d’utilisateur',
    ...
    usernameCooldown: 'Tu es @{handle}. Tu pourras le changer à nouveau le {date}.',
    usernameConfirmTitle: 'Changer de nom d’utilisateur ?',
    usernameConfirmBody: 'Tu seras @{handle}. Tu ne pourras pas le changer avant {days} jours.',
    password: 'Mot de passe',
  ...
  */
  ...
  widget: {
    ...
    todayDetail: 'Série, non lus et cartes à revoir, sur une ligne.',
