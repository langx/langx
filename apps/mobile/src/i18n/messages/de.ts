...
export const de: Localized<EnMessages> = {
  ...
  tabs: { discover: 'Entdecken', chats: 'Chats', echo: 'Echo', feed: 'Feed', me: 'Ich' },
  ...
  echo: {
    title: 'Echo',
    due: {
      one: '{count} Karte fällig',
      other: '{count} Karten fällig',
    },
    allCaughtUp: 'Gerade ist nichts fällig',
    review: 'Üben',
    allLanguages: 'Alle',
    added: 'Zu Echo hinzugefügt',
    alreadyAdded: 'Schon in Echo',
    removed: 'Aus Echo entfernt',
    addToEcho: 'Zu Echo hinzufügen',
    removeFromEcho: 'Aus Echo entfernen',
    bubbleAdd: '+ Echo',
    bubbleAdded: 'In Echo',
    addFailedTitle: 'Karte konnte nicht hinzugefügt werden',
    removeFailedTitle: 'Karte konnte nicht entfernt werden',
    limitTitle: 'Tageslimit für Echo erreicht',
    ...
    reviewWhich: 'Welche Sprache?',
    cardPhoto: 'Bild',
    addPhoto: 'Bild hinzufügen',
    replacePhoto: 'Bild ersetzen',
    removePhoto: 'Bild entfernen',
    cardAudio: 'Aufnahme',
    recordIt: 'Sprich es selbst',
  ...
  onboarding: {
    ...
    photoBody:
      'Wir haben dir ein Gesicht gezeichnet. Ein echtes Foto macht es viel wahrscheinlicher, dass dich jemand anschreibt — und die Bio ist auch freiwillig.',
    drawnFace: 'Für dich gezeichnet. Es bleibt, bis ein Foto es ersetzt.',
  ...
  welcomeBack: {
    ...
    handleBodyChoose:
      'Diesen Namen hat dir das alte LangX gegeben. Niemand sonst kann ihn nehmen — aber du darfst deinen eigenen wählen.',
    handleChoose: 'Eigenen Namen wählen',
    conversations: {
  ...
  discover: {
    ...
    searchNone: 'Kein Konto mit diesem Namen oder Benutzernamen.',
  ...
  chats: {
    ...
    unreadNew: { one: '{count} neu', other: '{count} neu' },
    tab_all: 'Alle',
  ...
  chat: {
    ...
    playbackRate: '{rate}×',
    playbackSpeed: 'Wiedergabegeschwindigkeit: {rate}×',
  ...
  profile: {
    ...
    rankLabel: 'Diese Woche',
    rankValue: '{percent}%',
    badgeStrip: { one: '{count} Abzeichen verdient', other: '{count} Abzeichen verdient' },
  ...
  editProfile: {
    ...
    usernameEvery: 'Du kannst das alle {days} Tage ändern.',
    usernameCooldown: 'Du kannst es am {date} wieder ändern.',
    pronouns: 'Pronomen',
  ...
  settings: {
    ...
    username: 'Benutzername',
    usernameBody: 'Alle {days} Tage änderbar',
    usernameTitle: 'Benutzernamen ändern',
    usernameIntro: 'Du bist @{handle}. Wähle den Benutzernamen, den du stattdessen möchtest.',
    usernameIntroV1:
      'Als du zum alten LangX kamst, hat es dich @{handle} genannt. Das hast du nie ausgesucht — jetzt kannst du es.',
    usernameHint: 'Buchstaben, Zahlen und Unterstriche. So finden dich andere.',
    usernameEvery:
      'Du kannst das alle {days} Tage ändern. Links und QR-Codes mit deinem alten Benutzernamen funktionieren weiter, bis du ihn erneut änderst.',
    usernameSave: 'Benutzernamen ändern',
    usernameSaved: 'Du bist jetzt @{handle}.',
    usernameFailed: 'Dein Benutzername konnte nicht geändert werden. Versuch es noch einmal.',
    usernameReserved: '@{handle} gehört einem anderen Konto aus dem alten LangX.',
    usernameCooldown: 'Du bist @{handle}. Du kannst ihn am {date} wieder ändern.',
    usernameConfirmTitle: 'Benutzernamen ändern?',
    usernameConfirmBody:
      'Du wirst @{handle} sein. Du kannst ihn erst in {days} Tagen wieder ändern.',
    password: 'Passwort',
  ...
  badges: {
    ...
    emptyBody: '@{handle} hat noch keins verdient. Es gibt sie fürs Dabeisein und fürs Helfen.',
  },
