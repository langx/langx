...
export const de: Localized<EnMessages> = {
  ...
  echo: {
    ...
    markLearned: 'Das kann ich',
    putItBack: 'Zurücklegen',
    archived: 'Gelernt',
    archivedEmptyTitle: 'Noch nichts abgelegt',
    archivedEmptyBody:
      'Karten, die du schon kannst, landen hier. Sie behalten alles und kommen nicht wieder.',
    selectCards: 'Karten auswählen',
    selectedCount: { one: '{count} ausgewählt', other: '{count} ausgewählt' },
    archivedToast: { one: '{count} Karte abgelegt', other: '{count} Karten abgelegt' },
  ...
  settings: {
    ...
    username: 'Benutzername',
    usernameBody: 'Einmal selbst wählen',
    usernameTitle: 'Benutzernamen wählen',
    usernameIntro:
    ...
    usernameOnce:
      'Das geht einmal. Links und QR-Codes mit deinem alten Benutzernamen funktionieren weiter, und niemand sonst kann ihn nehmen.',
    usernameSave: 'Nimm diesen Namen',
    ...
    usernameSpent:
      'Du hast deinen Benutzernamen gewählt: @{handle}. Er ändert sich nicht noch einmal.',
    password: 'Passwort',
