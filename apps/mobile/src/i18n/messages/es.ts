...
export const es: Localized<EnMessages> = {
  ...
  tabs: { discover: 'Descubrir', chats: 'Chats', echo: 'Echo', feed: 'Muro', me: 'Yo' },
  ...
  tour: {
    ...
    skip: 'Omitir',
    discoverPairTitle: 'Coincidencia en ambos sentidos',
    discoverPairBody:
      'Todas las personas de esta pantalla hablan el idioma que aprendes y aprenden uno que tú hablas. Toca el par para cambiarlo.',
  ...
  echo: {
    title: 'Echo',
    due: {
      one: '{count} tarjeta pendiente',
      other: '{count} tarjetas pendientes',
    },
    allCaughtUp: 'Ahora mismo no hay nada pendiente',
    review: 'Repasar',
    allLanguages: 'Todos',
    added: 'Añadida a Echo',
    alreadyAdded: 'Ya está en Echo',
    removed: 'Quitada de Echo',
    addToEcho: 'Añadir a Echo',
    removeFromEcho: 'Quitar de Echo',
    bubbleAdd: '+ Echo',
    bubbleAdded: 'En Echo',
    addFailedTitle: 'No se pudo añadir esta tarjeta',
    removeFailedTitle: 'No se pudo quitar esta tarjeta',
    limitTitle: 'Has llegado al límite diario de Echo',
    ...
    archiveCard: 'Archivar esta tarjeta',
    archiveCards: 'Archivar',
    unarchive: 'Devolverla',
    activeTab: 'Tarjetas',
    archived: 'Archivo',
    archivedEmptyTitle: 'Todavía no has archivado nada',
    archivedEmptyBody:
      'Las tarjetas que ya sabes vienen aquí. Lo conservan todo y dejan de volver, hasta que devuelvas alguna.',
    selectCards: 'Seleccionar tarjetas',
    selectedCount: { one: '{count} seleccionada', other: '{count} seleccionadas' },
    archivedToast: { one: '{count} tarjeta archivada', other: '{count} tarjetas archivadas' },
    ...
    reviewWhich: '¿Qué idioma?',
    cardPhoto: 'Imagen',
    addPhoto: 'Añadir una imagen',
    replacePhoto: 'Sustituir la imagen',
    removePhoto: 'Quitar la imagen',
    cardAudio: 'Grabación',
    recordIt: 'Dilo tú',
    removeAudio: 'Quitar la grabación',
    ...
    voiceFemale: 'Sintetizada · femenina',
    ...
    doneReviewed: 'Repasadas',
    doneRemembered: 'Acertadas',
    doneAgain: 'Otra vez',
  ...
  errors: {
    ...
    facebookSignInFailed: 'No se pudo iniciar sesión con Facebook',
    discordSignInFailed: 'No se pudo iniciar sesión con Discord',
  ...
  auth: {
    ...
    emailOrHandle: 'Correo o nombre de usuario',
    or: 'o',
  ...
  onboarding: {
    ...
    photoBody:
      'Te hemos dibujado una cara. Una foto real hace mucho más probable que alguien te salude, y la bio también es opcional.',
    drawnFace: 'Dibujada para ti. Se queda hasta que una foto la sustituya.',
  ...
  corrections: {
    ...
    emptyBody:
      'Mantén pulsado un mensaje y elige Corregir, o corrige una frase publicada en el feed: es lo más útil que puedes hacer aquí.',
  ...
  discover: {
    ...
    pickBody: 'Elige a alguien de la lista y su perfil se abrirá aquí.',
    boosted: 'Destacados',
    ...
    searchNone: 'No hay ninguna cuenta con ese nombre o nombre de usuario.',
    sortLabel: 'Ordenar',
    forYou: 'Para ti',
    title: 'Descubrir',
    active: 'Activos',
  ...
  chats: {
    ...
    unreadNew: { one: '{count} nuevo', other: '{count} nuevos' },
    tab_all: 'Todos',
  ...
  presence: {
    ...
    withTheirTimeAccessibility: '{presence}. Su hora local: {time}.',
  },
  chat: {
    ...
    partsReplyTitle: '¿A qué parte respondes?',
    partsCorrectTitle: '¿Qué frase corriges?',
    wordsTitle: 'Toca una palabra',
    askingCorrection: 'Pides que te corrijan',
    askingCorrectionHint: 'Escríbelo a tu manera; verán un botón Corregir.',
    askingPronunciation: 'Preguntas cómo suena',
    askingPronunciationHint: 'Escribe la frase; pueden responder con una nota de voz.',
    askCorrection: 'Pedir que me corrijan',
    askPronunciation: 'Preguntar cómo se dice',
    askBadgeCorrection: 'Quiere corrección',
    askBadgePronunciation: 'Quiere oírlo',
    askAnswerCorrect: 'Corregir',
    askAnswerSay: 'Decirlo',
    sendTranslatedOn: 'Enviar también en {language}',
    sendTranslatedOff: 'Dejar de enviar traducción',
    sendTranslatedBanner: 'También va en {language}',
    sendTranslatedHint: 'Escribe en tu idioma; van los dos.',
    sendTranslatedFailed: 'No se pudo traducir, así que se envió tal cual.',
    ...
    sendQuiz: 'Hacer una pregunta',
    quizQuestion: 'Pregunta',
    quizOption: 'Opción {number}',
    quizCorrect: '¿Cuál es la correcta?',
    quizNeedsOptions: 'Escribe al menos dos opciones y marca la correcta.',
    meetingAccept: 'Aceptar',
    meetingDecline: 'Rechazar',
    meetingCancel: 'Retirar',
    meetingAccepted: 'Aceptada',
    meetingDeclined: 'Rechazada',
    meetingCancelled: 'Retirada',
    meetingAddToCalendar: 'Añadir al calendario',
    meetingSummary: 'LangX con {name}',
    meetingCalendarFailed: 'No se pudo añadir esto a un calendario desde aquí.',
    meetingCalendarAdded: 'Añadido a tu calendario',
    meetingCalendarPermissionTitle: 'Acceso al calendario',
    meetingCalendarPermission:
      'LangX necesita permiso para añadir la sesión. Puedes activarlo en Ajustes.',
    meetingCalendarNone: 'No hay ningún calendario en este dispositivo donde añadirlo.',
    meetingYourTime: '{time} en tu hora',
    meetingTheirTime: '{time} en la suya',
    unsupportedMessage: 'Actualiza la app para ver este mensaje.',
    sendPhrase: 'Guardar una expresión',
    sendMeeting: 'Proponer una hora',
    phraseTerm: 'Palabra o expresión',
    phraseMeaning: 'Qué significa',
    phraseExample: 'Ejemplo (opcional)',
    ...
    playbackRate: '{rate}×',
    playbackSpeed: 'Velocidad de reproducción: {rate}×',
    ...
    wordTranslationFailed: 'No se pudo traducir esa palabra ahora mismo.',
    wordSeePlans: 'Ver los planes',
  ...
  editProfile: {
    ...
    photoPreparing: 'Preparando la foto…',
    photoUploading: 'Subiendo foto, {percent} %',
    photoRetry: 'Esa foto no se subió. Toca para reintentar o mantén pulsado para quitarla.',
    photoRetryShort: 'Reintentar',
    photoLimit: 'Puedes añadir hasta {max} fotos.',
    photosTrimmed: 'Tu galería admite {max} fotos, así que no se añadieron todas.',
  ...
  languages: {
    ...
    nativeBody: 'Los idiomas con los que creciste. Quien los aprende te encuentra así.',
    learningSection: 'Aprendiendo',
    learningBody: 'Lo que estás aprendiendo. El primero encabeza tu perfil.',
    addNative: 'Añadir un idioma nativo',
    addLearning: 'Añadir un idioma que aprendes',
    pickNativeTitle: 'Idioma nativo',
    pickLearningTitle: 'Idioma que aprendes',
    replaceTitle: 'Cambiar {language}',
    replaceBody: 'Elige el idioma que ocupa su lugar.',
    startsAtNew: 'Empieza en el primer nivel. Puedes cambiarlo después.',
    alreadyInList: 'Ya tienes {language}.',
    ...
    lastLearning: 'Necesitas al menos un idioma que aprendas. Cámbialo en vez de quitarlo.',
    capReached: {
      one: 'Tu plan admite {count} idioma en esta lista.',
      other: 'Tu plan admite {count} idiomas en esta lista.',
    },
    capReachedShort: {
    ...
    saveFailed: 'No se guardó. No cambió nada.',
  },
  ...
  kitchen: {
    ...
    stickerCredit: 'Algunos stickers son de Microsoft Fluent Emoji, con licencia MIT.',
  ...
  settings: {
    ...
    appearanceBody: 'Tema, icono de la app, idioma y consejos',
    accountBody: 'Cómo entras, dispositivos, bloqueados, tus datos',
    signInMethods: 'Métodos de acceso',
    signInMethodsBody: 'Cómo entras en tu cuenta',
    signInIdentifiers: 'Puedes entrar con cualquiera de estos:',
    signInPasswordTitle: 'Contraseña',
    signInPasswordSet: 'Configurada',
    signInPasswordNotSet: 'Sin configurar',
    signInSetPassword: 'Crear una contraseña',
    signInSetPasswordBody: 'Para entrar sin Google ni Apple.',
    ...
    changePasswordSaved: 'Contraseña cambiada.',
    changePasswordFailed: 'No se pudo cambiar tu contraseña. Inténtalo de nuevo.',
    currentPasswordWrong: 'Esa no es tu contraseña actual.',
    signInConnected: 'Cuentas conectadas',
    signInConnectedSince: 'Conectada el {date}',
    signInNoneConnected: 'Nada conectado',
    signInOnlyProvider:
      'Es tu única forma de entrar. Crea una contraseña para no quedarte fuera si pierdes el acceso.',
    aboutSection: 'Acerca de',
    aboutBody: 'Legal, comunidad y la introducción',
    search: 'Buscar en ajustes',
    searchNone: 'Ningún ajuste coincide.',
    ...
    showTour: 'Repetir el recorrido',
    showTourBody: 'Recorre la pantalla Descubrir otra vez, paso a paso.',
    rateApp: 'Valorar LangX',
  ...
  store: {
    ...
    notEnoughBody: '{title} cuesta {price}. Tienes {balance}.',
  ...
  badges: {
    ...
    emptyBody: '@{handle} todavía no ha ganado ninguna. Se dan por aparecer y por ayudar.',
  },
  ...
  share: {
    ...
    shapeWide: 'X / Twitter',
    justTheLink: 'Solo el enlace',
    cardFailed: 'No se pudo crear la imagen. Se comparte el enlace.',
    action: 'Compartir',
    copied: 'Enlace copiado',
  ...
  linkDevice: {
    ...
    approve: 'Aprobar',
    deny: 'Rechazar',
    approved: 'Inicio de sesión aprobado.',
    denied: 'Inicio de sesión rechazado.',
  ...
  watch: {
    ...
    phoneNotReachable: 'Teléfono no disponible',
    reply: 'Responder',
    sending: 'Enviando…',
    sent: 'Enviado',
    notSent: 'No enviado',
  ...
  */
  intents: {
    openEcho: 'Abrir Echo',
    openEchoDetail: 'Ir directo a las tarjetas de hoy.',
    openChats: 'Abrir mis mensajes',
    openChatsDetail: 'Ir directo a la lista de chats.',
    openConversation: 'Abrir un chat',
    openConversationDetail: 'Ve directo a la conversación con alguien con quien hablas.',
    conversationType: 'Conversación',
    conversationParameter: 'Chat con',
  },
  widget: {
