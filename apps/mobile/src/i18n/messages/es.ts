...
export const es: Localized<EnMessages> = {
  ...
  me: {
    ...
    leaderboardSubtitle: 'Rachas y correcciones',
    proTitle: '✦ LangX Pro',
  ...
  settings: {
    ...
    pushTitle: 'Mensajes y recordatorios',
    pushBody: 'Mensajes nuevos y un recordatorio de racha al día.',
  ...
  paywall: {
    ...
    advancedFiltersBody: 'Busca por género, país, edad y nivel.',
  ...
  languageCards: {
    studyTitle: 'Idioma(s) que estudias',
    studySubtitle: 'El idioma o idiomas que practicas y aprendes',
    nativeTitle: 'Lengua(s) materna(s)',
    nativeSubtitle: 'El idioma o idiomas que hablas en casa',
  },
