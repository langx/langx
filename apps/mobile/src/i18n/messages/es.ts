...
export const es: Localized<EnMessages> = {
  ...
  discover: {
    ...
    boostedExplainBody:
      'Aquí se muestran las personas con Fluent y Polyglot, primero Polyglot. El orden va rotando durante el día, así que todos pasan por delante. Se emparejan por idiomas igual que la lista de abajo: nada cambia en el emparejamiento, y cualquiera puede desactivarlo en Ajustes.',
